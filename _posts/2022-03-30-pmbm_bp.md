...
In the MSc thesis the goal will be to scale up the results from the specialisation project from toy examples to realistic tracking problems, and to integrate the techniques in a complete PMBM-based tracking system. 
