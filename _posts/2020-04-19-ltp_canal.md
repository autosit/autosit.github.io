...
The overall goal of this project is to enable realistic simulations of traffic in the harbour environment. The results will be integrated in the aforementioned MilliAmpere simulator. This is just a part of the simulator (other parts being, e.g., sensor modeling), but it is a very important part. The project is intended for a single student, but can also be solved as a collaboration of two or more students. 
