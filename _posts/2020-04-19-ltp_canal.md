...
The last task may possible be done in collaboration with [Simulation-based evaluation of autonomous guidance systems with collision avoidance functionality].
