...
|<span style="color:#959595"> The ferry MS Nidarholm and its maneuvering out of its quay position recorded in lidar data (different colors are different time steps). The goal of extended object tracking is to estimate its position, velocity, size and orientation from these data. </span>| 
