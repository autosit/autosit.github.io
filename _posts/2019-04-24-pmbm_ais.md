...
| Example application 1: The autonomous ferry [Milliampere] should be able to use AIS to for warm track initiation on the Munkholmen ferry when it approaches under the bridge. |

|<img src="{{site.url}}/assets/droneit.png" width="700"> | 
