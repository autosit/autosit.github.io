...
| Example application: The autonomous ferry [Milliampere] should be able to use AIS to for warm track initiation on the Munkholmen ferry when it approaches under the bridge. |
